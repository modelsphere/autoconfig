...
|---|---|---|
| autoconfig controller | `autoconfig-0.3.28` | `autoconfig:0.3.28` |
| openresty | `openresty-0.1.1` | `llm-openresty:0.1.1` + sidecar `autoconfig-reload/hagate:0.3.28` |
| cart | `cache_aware_router-0.1.1` (app `v0.6.2-k8s`) | `cache_aware_router:v0.6.2-k8s` + sidecar `:0.3.28` |
