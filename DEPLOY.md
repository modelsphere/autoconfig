...
helm show chart harbor-chart-repo/autoconfig         --version 0.3.26     | grep -E '^name|^version'
...
```bash
helm -n llm-route install autoconfig harbor-chart-repo/autoconfig --version 0.3.26 \
