...
helm show chart harbor-chart-repo/autoconfig         --version 0.3.29     | grep -E '^name|^version'
...
```bash
helm -n llm-route install autoconfig harbor-chart-repo/autoconfig --version 0.3.29 \
...
RELOAD=harbor.4pd.io/hardcore-tech/autoconfig-reload:0.3.29
HAGATE=harbor.4pd.io/hardcore-tech/autoconfig-hagate:0.3.29
...
helm -n llm-route install openresty harbor-chart-repo/openresty --version 0.1.1 \
  ...
  --set reload.image=harbor.4pd.io/hardcore-tech/autoconfig-reload:0.3.29 \
  --set ha.image=harbor.4pd.io/hardcore-tech/autoconfig-hagate:0.3.29
